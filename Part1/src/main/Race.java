...
public class Race {
    ...
    public void addHorse(Horse theHorse, int laneNumber) {
        if (laneNumber == 1) {
            ...
            System.out.println(
                    "Cannot add horse to lane " + laneNumber + " because there is no such lane");
        }
    }
    ...
    public void startRace() {
        ...
        // Store horses in an array for easy looping
    ...
    /**
     * Randomly make a horse move forward or fall depending on its confidence rating A fallen horse
     * cannot move
     *
    ...
    /**
     * print a horse's lane during the race for example
     * |           X                      | to show
